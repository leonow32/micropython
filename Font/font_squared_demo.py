...
display.print_text(squared16B_unicode, "ABEFGHKPRS", 0, 16, "C")
...
display.print_text(squared16B_unicode, "АБВЕЁЖЗКМНПРУ", 0, 16, "C")
display.print_text(squared16_unicode, "ХЧЪЫЬЭЮЯЄЋЂЈЉЊ", 0, 32, "C")
display.print_text(squared16B_unicode, "ХЧЪЫЬЭЮЯЄЋЂЈЉЊ", 0, 48, "C")
display.refresh()

...
dihal.text("ABCDEFGHIJKLM",              0,  0, mini8B, ALIGN_CENTER)
dihal.color_set(YELLOW, BLACK)
dihal.text("NOPQRSTUVWXYZ",              0, 14, mini8B, ALIGN_CENTER)
dihal.color_set(GREEN, BLACK)
dihal.text("abcdefghijklmnopqrstuvwxyz", 0, 28, mini8B, ALIGN_CENTER)
dihal.color_set(CYAN, BLACK)
dihal.text("0123456789+-*/=()[]{}<>",    0, 42, mini8B, ALIGN_CENTER)
dihal.color_set(BLUE, BLACK)
dihal.text("`~!@#$%^&*.,:;'|\/_\"",      0, 56, mini8B, ALIGN_CENTER)

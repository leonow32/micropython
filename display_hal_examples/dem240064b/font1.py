...
measure_time.begin()
dihal.text("abcdefghijklmnopqrstuvwxyz0123456789",  0, 1, extronic16B_unicode, ALIGN_CENTER)
dihal.text("ABCDEFGHIJKLMNOPQRSTUVWXYZ",           16, 1, extronic16B_unicode, ALIGN_CENTER)
dihal.text("абвгдеёжзийклмнопрстуфхцчшщъыьэ",      32, 1, extronic16B_unicode, ALIGN_CENTER)
dihal.text("АБВГДЕЁЖЗИЙКЛМНОПРСТУФХЦЧШЩ",          48, 1, extronic16B_unicode, ALIGN_CENTER)

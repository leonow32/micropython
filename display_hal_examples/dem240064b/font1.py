...
measure_time.begin()
dihal.text("abcdefghijklmnopqrstuvwxyz0123456789", 0,  0, extronic16B_unicode, ALIGN_CENTER)
dihal.text("ABCDEFGHIJKLMNOPQRSTUVWXYZ",           0, 16, extronic16B_unicode, ALIGN_CENTER)
dihal.text("абвгдеёжзийклмнопрстуфхцчшщъыьэ",      0, 32, extronic16B_unicode, ALIGN_CENTER)

...
elif dihal.width == 240:
    dihal.text("abcdefghijklmnopqrstuvwxyz0123456789", 0,  0, extronic16_unicode,  ALIGN_CENTER)
    dihal.text("abcdefghijklmnopqrstuvwxyz0123456789", 0, 16, extronic16B_unicode, ALIGN_CENTER)
    dihal.text("ABCDEFGHIJKLMNOPQRSTUVWXYZ",           0, 32, extronic16_unicode,  ALIGN_CENTER)
    dihal.text("ABCDEFGHIJKLMNOPQRSTUVWXYZ",           0, 48, extronic16B_unicode, ALIGN_CENTER)
    dihal.refresh()
    input("Press enter")
    
    dihal.text("абвгдеёжзийклмнопрстуфхцчшщъыьэ",      0, 0,  extronic16_unicode,  ALIGN_CENTER)
    dihal.text("абвгдеёжзийклмнопрстуфхцчшщъыьэ",      0, 16, extronic16B_unicode, ALIGN_CENTER)
    dihal.text("АБВГДЕЁЖЗИЙКЛМНОПРСТУФХЦЧШЩ",          0, 32, extronic16_unicode,  ALIGN_CENTER)
    dihal.text("АБВГДЕЁЖЗИЙКЛМНОПРСТУФХЦЧШЩ",          0, 48, extronic16B_unicode, ALIGN_CENTER)
    dihal.refresh()
